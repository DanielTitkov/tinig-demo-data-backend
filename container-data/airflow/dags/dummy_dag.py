...
t16 = DummyOperator(task_id='task16', dag=dag)
t17 = DummyOperator(task_id='task17', dag=dag)
t18 = DummyOperator(task_id='task18', dag=dag)
t19 = DummyOperator(task_id='task19', dag=dag)
t20 = DummyOperator(task_id='task20', dag=dag)
